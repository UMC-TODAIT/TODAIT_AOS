 ...
 * 비밀번호 재설정용 발송(POST /api/auth/password-reset/email/send-code)이 형태가 같아 공용으로 쓴다.
 *
 ...
 * 비밀번호 재설정용 확인(POST /api/auth/password-reset/email/verify-code)이 형태가 같아 공용으로 쓴다.
 */
