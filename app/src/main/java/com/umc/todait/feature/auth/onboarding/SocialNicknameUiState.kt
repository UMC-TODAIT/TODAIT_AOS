...
data class SocialNicknameUiState(
    ...
    /** 온보딩 완료(PATCH /api/members/me/onboarding) 호출 중. */
    val isSubmitting: Boolean = false,
    /** 온보딩 완료 실패 메시지(MEMBER409/TERM400/AUTH401/AUTH410 등). null이면 표시 안 함. */
    ...
    /** 시작하기 버튼 활성: 사용 가능으로 확인됐고 제출 중이 아닐 때만. */
    val isStartEnabled: Boolean
        get() = status == NicknameStatus.AVAILABLE && !isSubmitting
}
