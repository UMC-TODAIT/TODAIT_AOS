...
// 취향 설정 카드 "선택됨" 배경 (Figma). 선택하면 같은 계열에서 채도가 올라간 그라데이션으로 바뀐다.
// 미선택 배경은 위의 Course·Food 그라데이션 값을 그대로 쓴다.
val MoodHipSelectedGradientStart = Color(0xFFA1C7E2)
val MoodHipSelectedGradientEnd = Color(0xFFCABBFC)
val MoodQuietSelectedGradientStart = Color(0xFFD7E7C0)
val MoodQuietSelectedGradientEnd = Color(0xFFD3D8A0)
val MoodActiveSelectedGradientStart = Color(0xFFFFC5B4)
val MoodActiveSelectedGradientEnd = Color(0xFFFFD5C0)
val MoodRomanticSelectedGradientStart = Color(0xFFFFABBD)
val MoodRomanticSelectedGradientEnd = Color(0xFFFFB2EC)
val MoodModernSelectedGradientStart = Color(0xFFBFE1DE)
val MoodModernSelectedGradientEnd = Color(0xFF7CA2BA)
val MoodCalmSelectedGradientStart = Color(0xFFB4EDC9)
val MoodCalmSelectedGradientEnd = Color(0xFF99C6CE)

val FoodKoreanSelectedGradientStart = Color(0xFFE1D9B2)
val FoodKoreanSelectedGradientEnd = Color(0xFFE6E89B)
val FoodJapaneseSelectedGradientStart = Color(0xFFC3D59F)
val FoodJapaneseSelectedGradientEnd = Color(0xFFEBFFC3)
val FoodWesternSelectedGradientStart = Color(0xFFB5DDFB)
val FoodWesternSelectedGradientEnd = Color(0xFFEEB9B9)
val FoodChineseSelectedGradientStart = Color(0xFFFFB5B5)
val FoodChineseSelectedGradientEnd = Color(0xFFE9DDAB)
val FoodSnackSelectedGradientStart = Color(0xFFE8CBF6)
val FoodSnackSelectedGradientEnd = Color(0xFFDDADA3)
val FoodDessertSelectedGradientStart = Color(0xFFFFC5E2)
val FoodDessertSelectedGradientEnd = Color(0xFFEDC78F)
